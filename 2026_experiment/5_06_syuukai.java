...
//周回の速度を上げるためには、横フリの数を減らす

const int motor_r1 = 2; //Arduinoピンの位置
const int motor_r2 = 3; //Arduinoピンの位置
...
int forwardR = 125;//150;
int forwardL = 175;//200; 
void moveForward() {
    // 左：正転
